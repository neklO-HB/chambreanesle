        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              {['facebook-f', 'instagram', 'pinterest-p'].map((icon) => (
                <a key={icon} href="#" className="text-black transition duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/chambres" className="transition duration-300">Nos chambres</a></li>
              <li><a href="/reservation" className="transition duration-300">Réservation</a></li>
              <li><a href="/a-propos" className="transition duration-300">À propos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/reservation" className="transition duration-300">Tarifs & Disponibilités</a></li>
              <li><a href="/reservation" className="transition duration-300">Offres spéciales</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-lg font-bold mb-6">Newsletter</h4>
            <p className="text-black mb-4">Inscrivez-vous pour recevoir nos offres exclusives</p>
            <form className="flex">
              <input type="email" placeholder="Votre email" className="px-4 py-2 w-full rounded-l-lg text-black focus:outline-none" />
              <button className="bg-white hover:bg-secondary px-4 rounded-r-lg text-black">
